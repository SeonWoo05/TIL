...
data = {
    ...
    'population': [34168, 23387, 26043, 28211, 19425, 11180, 23437, 21862, 23946, 27553, 17926, 15299, 20999, 15945, 28035],
...
# 독립 변수 선택
features = ['population', '1인가구수', '여성인구', 'cctv', '경찰서', '버스', '지하철']
X = df[features]
...
# 각 변수에 대한 밀도 함수 그리기
fig, axes = plt.subplots(2, 3, figsize=(12, 8))  # 2행 3열의 subplot을 만듦

cluster_names = ['A', 'B', 'C']
cluster_colors = ['red', 'blue', 'green']  # 각 군집에 대한 색깔 지정

for i, feature in enumerate(features):
    row = i // 3  # subplot의 행 인덱스
    col = i % 3   # subplot의 열 인덱스
